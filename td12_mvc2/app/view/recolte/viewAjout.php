...
<div class="container">
    ...
    <form role="form" method='get' action='router2.php'>
        <div class="form-group">
            ...
            <label for="id">Sélectionnez un vin : </label> <select class="form-control" id='id' name='vin' style="width: 300px">
                <?php
            ...
            <label for="id">Sélectionnez un producteur : </label> <select class="form-control" id='id' name='producteur' style="width: 300px">
                <?php
