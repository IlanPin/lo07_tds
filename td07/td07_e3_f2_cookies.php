<?php
$endtime = time() + 60;
setcookie("organisation", $_GET["organisation"], $endtime);
setcookie("address", $_GET["address"], $endtime);
setcookie("date", $_GET["date"], $endtime);
?>
<!doctype html>
<html lang="fr">
  <head>
        ...
        <div class="card-body bg-info">
          <h5 class="card-title">Formulaire 2</h6>
            <div class='mx-lg-3'>
                ...
                <form method="GET" action="td07_e3_f3_cookies">
