        ...
        <div class="card-body bg-info">
          <h5 class="card-title">Formulaire 2</h6>
            <div class='mx-lg-3'>
                ...
                <form method="GET" action="td07_e3_f3_hidden">
                    ...
                    <input type="hidden" name="resp_org" value="COLLET christophe">
                    <input type="hidden" name="resp_proces" value="PIN ilan">
                    <input type="hidden" name="DPO" value="NIGRO jean-marc">
